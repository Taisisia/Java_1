...
public class Util {
    ...
    public static char getOperation() {
        ...
        while (operation != org.example._20240814.Constant.SIGN_PLUS && operation != org.example._20240814.Constant.SIGN_MINUS && operation != org.example._20240814.Constant.SIGN_MULTI && operation != org.example._20240814.Constant.SIGN_DIV && operation != org.example._20240814.Constant.SIGN_PROC);
        {
    ...
    public static double getResalt(double numFirst, double numSecond, char operation) {
        double res = 0;
        switch (operation) {
            case org.example._20240814.Constant.SIGN_PLUS:
                res = numFirst + numSecond;
                break;
            case org.example._20240814.Constant.SIGN_MINUS:
                res = numFirst - numSecond;
                break;
            case org.example._20240814.Constant.SIGN_MULTI:
                res = numFirst * numSecond;
                break;
            case org.example._20240814.Constant.SIGN_DIV:
                res = numFirst / numSecond;
                break;
