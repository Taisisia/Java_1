...
import org.example._20240814.Util;
...
public class Calculator {
    ...
    public void run() {
        ...
        int count;
        do {
            count = org.example._20240816.Util.getCount();// получили кол-во єлементов
            arr = new double[count]; // создали массив
            for (int i =0; i < count; i++){// заполнили массив аргументами которіе вводит пользователь
                arr [i] = org.example._20240816.Util.getNum();
            }
...
//            argumentTwo = org.example._20240814.Util.getNum(true, operation);
            res = org.example._20240816.Util.getResalt(arr, operation);
            org.example._20240816.Util.printResalt(arr, operation, res);
